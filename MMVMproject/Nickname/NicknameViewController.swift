...
//        nameTextField.backgroundColor = .blue
    ...
    @objc func textFieldTapped() {
        ...
        viewmodel.inputname = nameTextField.text
        alertLabel.text = viewmodel.namecheck
        
        alertLabel.textColor = viewmodel.namebool ? .orange : .black
        checkButton.backgroundColor = viewmodel.namebool ? .orange : .lightGray
    }
}
